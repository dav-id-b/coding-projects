#This code runs a random number generator guessing game in the terminal. It gives various hints in regard to guess correctness.
...
#digits = str(digits[0]) + str(digits[1]) + str(digits[2])
